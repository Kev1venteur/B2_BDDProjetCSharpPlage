...
ALTER TABLE dbo.ZonesPrelevements
	DROP COLUMN nbEspecesDifferentes
GO
...
GO
ALTER TABLE dbo.Plages
	DROP COLUMN nombreEspecesDifferentes
GO
...
ALTER TABLE dbo.Etudes
	DROP COLUMN nbTotalEspeceRencontrees
GO
...
ALTER TABLE dbo.Equipes
	DROP COLUMN nbMembres
GO
ALTER TABLE dbo.Equipes SET (LOCK_ESCALATION = TABLE)
GO
COMMIT
select Has_Perms_By_Name(N'dbo.Equipes', 'Object', 'ALTER') as ALT_Per, Has_Perms_By_Name(N'dbo.Equipes', 'Object', 'VIEW DEFINITION') as View_def_Per, Has_Perms_By_Name(N'dbo.Equipes', 'Object', 'CONTROL') as Contr_Per 